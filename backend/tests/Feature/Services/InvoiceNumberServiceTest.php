...
class InvoiceNumberServiceTest extends TestCase
{
    ...
    public function test_logos_share_the_single_sequence_for_their_fiscal_profile(): void
    {
        ...
        $this->assertSame('FAC-PM-000001', $service->generate(
            date: '2026-07-13',
            fiscalProfileId: $profile->id,
            documentType: 'invoice',
            logoPath: 'logos/pamela-a.png',
        ));
        $this->assertSame('FAC-PM-000002', $service->generate(
            date: '2026-07-13',
            fiscalProfileId: $profile->id,
            documentType: 'invoice',
            logoPath: 'logos/pamela-b.png',
        ));

        $this->assertSame(1, InvoiceNumberSetting::query()
