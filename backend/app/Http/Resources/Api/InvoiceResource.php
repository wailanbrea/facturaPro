...
class InvoiceResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'intervention' => $this->whenLoaded('intervention', fn (): ?array => $this->intervention === null ? null : [
                'equipment_type' => $this->intervention->equipment_type,
                'equipment_brand' => $this->intervention->equipment_brand,
                'equipment_model' => $this->intervention->equipment_model,
                'equipment_serial' => $this->intervention->equipment_serial,
                'equipment_location' => $this->intervention->equipment_location,
                'units_indoor' => $this->intervention->units_indoor,
                'units_outdoor' => $this->intervention->units_outdoor,
                'diagnostic_summary' => $this->intervention->diagnostic_summary,
                'technical_conclusions' => $this->intervention->technical_conclusions,
                'service_scope' => $this->intervention->service_scope,
                'included_items' => $this->intervention->included_items,
            ]),
